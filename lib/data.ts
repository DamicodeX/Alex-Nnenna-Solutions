...
export const siteConfig = {
  ...
  founder: "Dr. Alexander Attah",
  title: "Strategic Governance & Human Capacity Consultant",
  ...
  links: {
    linkedin: "https://www.linkedin.com/company/alexnnenna-solutions-nig-ltd/",
  },
};
...
export const heroContent = {
  headlinePrefix: "Bridging Academic Excellence with",
...
export const aboutContent = {
  ...
  credentials: [
    { label: "Education", value: "PhD & MA (Distinction) in Peace and Conflict Studies, UI" },
    { label: "Current Role", value: "Director, Centre for Advancement & Internationalisation, MTU" },
    { label: "Experience", value: "10+ Years in Higher Education & Governance" },
  ],
};
...
//       description: "Analysis of democratic institutions and public sector development strategies.",
//     },
//     {
//       area: "Conflict Resolution",
//       description: "Advancing peacebuilding scholarship and corporate mediation frameworks.",
//     },
//     {
//       area: "Leadership Performance",
//       description: "Benchmarking and enhancing organizational leadership through policy-relevant research.",
//     },
//   ],
// };
...
export const trustContent = {
  heading: "Trusted by Leading Academic & Research Institutions",
  institutions: [
    {
      name: "Mountain Top University",
      logo: "/institution/MTU's Logo.jpg", 
      alt: "Mountain Top University Logo",
      subtext: "Director, Centre for Advancement"
    },
    {
      name: "University of Ibadan",
      logo: "/institution/UI's Logo.jpg", 
      alt: "University of Ibadan Logo",
      subtext: "PhD in Peace & Conflict Studies"
    },
]
}
...
export const corePillars = [
  {
    ...
    description: "Transforming organizational potential into performance through strategic mentoring and specialized leadership training.",
    features: [
      "Executive Leadership Mentoring",
      "Public Sector Workforce Optimization",
      "Performance Benchmarking",
      "Emerging Researcher Mentorship"
    ],
  ...
  },
  {
    ...
    description: "Utilizing advanced peacebuilding scholarship to navigate complex security challenges and corporate disputes.",
    features: [
      "Corporate & Institutional Mediation",
      "Security Framework Analysis",
      "Peacebuilding Scholarship Advisory",
